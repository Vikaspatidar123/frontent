							...
							<div className="col-lg-7">
								<div className="text-center">
									<h4 className="mb-3">
										...
										<span className="text-primary">5k</span>+ Satisfied clients
									</h4>
									<div dir="ltr">
										<Carousel
												...
												<div className="item">
													<div className="pb-5 pt-3">
														<p className="font-size-16 mb-4">
															&quot;Fantastic BO with a ton of options. If you
															just want the HTML to integrate with your project,
															then this is the package. You can find the files
															in the &apos;dist&lsquo; folder...no need to
														...
														<div>
															...
															<p className="font-size-14 mb-0">- ARC User</p>
														</div>
													</div>
												</div>
											</div>
												...
												<div className="item">
													<div className="pb-5 pt-3">
														<p className="font-size-16 mb-4">
															...
															as Gammastack, Development with be a nice
