...
const channelCriteria = [
	{
		...
		tooltipContent: 'If True Channel joining by user will have a KYC verification criteria',
	},
	// {
	...
	// 	tooltipContent: 'If True Channel joining by user will have a wagering criteria',
	// },
	// {
	// 	label: 'Tier Level',
